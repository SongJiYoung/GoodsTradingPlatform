	...
	$(document).ready(
			function() {
				...
				$(".join_button").click(function() {
			        ...
			        /* 전화번호 유효성검사 */
			        if(phone == ""){
			        	$('.final_phone_check').css('display', 'block');
			        	phoneCheck = false;
			        } else {
			        	$('.final_phone_check').css('display', 'none');
			        	phoneCheck = true;
			        }
					...
					if(idCheck&&idckCheck&&pwCheck&&pwckCheck&&pwckcorCheck&&nameCheck&&mailCheck&&mailnumCheck&&addressCheck&&phoneCheck ){
						...
						/* 위 조건중에 하나라도 비여있으면 submit 거부 */
						alert('모든 입력창을 채워 주십시요');
					}
				...
				$(".address_button").click(function() {
					new daum.Postcode({
						oncomplete : function(data) {
			                ...
			                // 상세주소 입력란 disabled 속성 변경 및 커서를 상세주소
				...
				<div class="id_wrap">
					...
					<div class="phone_wrap">
						...
						<div class="phone_input_box">
							...
							<span class="final_phone_check">전화번호를 입력해주세요.</span>
